...
class Pipeline(Stack):
    ...
    # Pipeline
    pipeline = pipelines.CodePipeline("GitHubPipeline",cross_account_keys=False,synth=pipelines.ShellStep("Synth",input=github_repo,commands=["npm ci", "npm run build", "npx cdk synth"]))
